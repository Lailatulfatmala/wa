...
def logo_taekyung():
    try:
        os.system("clear")
        mengetik(f'\033[36;1mSubscribe yt ku ngab \033[37mMisterAM \033[36mok! :v')
        os.system("xdg-open https://youtube.com/c/MisterAM")
        time.sleep(3)
        os.system('clear')
        mengetik('\033[36;1mjoin grub \033[37;1mwa gua ngab :v')
...
""")
        ...
        sys.exit(f"{W}[{R}!{W}] Eror Cek Jaringan ngab{abu}....{abu}")
